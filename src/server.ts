...
//     try {
//       const token = linkedin_access_token; // Replace with your LinkedIn access token
...
//       res.json(posts);
//     } catch (error) {
//       console.error('Error retrieving LinkedIn posts:', error);
//       res.status(500).json({ fail: 'Failed to retrieve LinkedIn posts', error });
//     }
//   });